...
public class BooleanButton extends Component {
    ...
    public BooleanButton(final SettingBoolean setting, final ModuleButton button, final int offset) {
    ...
    public void render() {
        ...
        FiveGuysMain.textManager.drawStringWithShadow(setting.getName(), button.frame.getX() + 5, button.frame.getY() + offset + 1, setting.getValue()  ? -1 : new Color(170, 170, 170).getRGB());
    }
